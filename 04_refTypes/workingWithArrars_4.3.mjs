...
console.log(result2);
console.log('\n--- copy from within an array ---');
const groceries = ['milk', 'cheese', 'bread', 'jelly', 'salad', 'avocados'];
console.log(groceries);
groceries.copyWithin(0, 2, 4);
console.log(groceries);
console.log('\n--- convert arrays to a string ---');
const grocString = groceries.toString();
console.log(grocString);
